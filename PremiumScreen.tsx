...
const plans: SubscriptionPlan[] = [
  { name: 'Weekly Plan', price: 99, durationDays: 7, description: '₹99/सप्ताह - 12 E-books डाउनलोड' },
  { name: 'Monthly Plan', price: 199, durationDays: 30, description: '₹199/माह - 50 E-books डाउनलोड', badge: 'लोकप्रिय' },
  { name: 'Yearly Plan', price: 599, durationDays: 365, description: '₹599/वर्ष - अनलिमिटेड E-books', badge: 'महा बचत (75% छूट)' }
];
    ...
    return (
        <Card className="animate-fade-in max-w-3xl mx-auto">
            ...
            <div className="text-center">
                ...
                <p className="text-lg text-purple-200 mb-6">सभी 'तंत्र मंत्र यंत्र PDF E-book' तक पहुंच प्राप्त करें और सीधे डाउनलोड करें।</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {plans.map(plan => (
                        <div key={plan.name} className={`relative p-6 bg-white/5 border-2 rounded-2xl flex flex-col text-center transition-transform hover:scale-105 ${plan.badge ? 'border-amber-400 shadow-[0_0_15px_rgba(251,191,36,0.2)]' : 'border-white/20'}`}>
                            ...
                            <p className="text-purple-300 mb-4 text-sm font-semibold">{plan.description}</p>
